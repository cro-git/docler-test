 ...
 * Generated for Laravel 7.1.1 on 2020-04-08 16:34:07.
 *
...
namespace Suitmedia\Cacheable { 
    ...
    class Facade {
        ...
        {
                        /** @var \Suitmedia\Cacheable\CacheableService $instance */
                        return $instance->build($repository);
        }
         ...
         * @static 
         */ 
        public static function retrieve($tags, $key, $duration, $callable)
        {
                        /** @var \Suitmedia\Cacheable\CacheableService $instance */
                        return $instance->retrieve($tags, $key, $duration, $callable);
        }
         ...
         * @static 
         */ 
        public static function wrap($repository)
        {
                        /** @var \Suitmedia\Cacheable\CacheableService $instance */
                        return $instance->wrap($repository);
        }
